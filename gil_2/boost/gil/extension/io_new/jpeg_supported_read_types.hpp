...
template<> image_type_factory< 1, gray_layout_t >
{ typename gray8_image_t type; };

template<> image_type_factory< 3, rgb_layout_t >
{ typename gray8_image_t type; };

template<> image_type_factory< 4, cmyk_layout_t >
{ typename gray8_image_t type; };
