...
template< typename Channel
        , typename ColorSpace
        >
struct png_rw_support : read_write_support_false
{};
...
template< typename BitField
        , bool     Mutable
        >
struct png_rw_support< packed_dynamic_channel_reference< BitField
                                                       , 1
                                                       , Mutable
                                                       >
                     , gray_t
...
struct is_supported< Pixel
                   , png_tag
                   >
    : mpl::bool_< detail::png_rw_support< typename channel_type< Pixel >::type
