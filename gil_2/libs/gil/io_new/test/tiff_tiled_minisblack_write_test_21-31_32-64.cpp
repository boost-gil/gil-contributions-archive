...
BOOST_AUTO_TEST_CASE( write_tile_and_compare_with_minisblack_strip_32 )
{
    ...
    write_test_view( tiff_out + "write_minisblack_tile_and_compare_with_32.tif", view(img_strip), info );
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_test_view( tiff_out + "write_minisblack_tile_and_compare_with_64.tif", view(img_strip), info );
