...
private:
    ...
    typedef typename detail::min_fast_uint< bit_size + 7 > bitfield_t;
...
struct pixel_value_type<packed_channel_value<NumBits>,Layout> :
    public packed_pixel_type<typename uint_t< NumBits >::least, mpl::vector1_c<unsigned,NumBits>, Layout> {};
